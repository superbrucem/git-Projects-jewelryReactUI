...
const Header = () => {
  ...
  return (
    <>
      ...
      {/* Purple banner with scrollable content */}
      <Box sx={{
        backgroundColor: '#1e2761', // Purple color from your image
        py: 1.2, // Double the padding of the black banner
        width: '100%',
        display: 'flex',
        alignItems: 'center',
        justifyContent: 'center',
        ...
        <Box sx={{
          ...
          <Typography variant="body2" sx={{ fontWeight: 400, fontSize: '0.85rem', color: 'white', mx: 2, py: 0.6 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', mx: 2 }}>
            ...
            <Typography variant="body2" sx={{ fontWeight: 400, fontSize: '0.85rem', color: 'white', py: 0.6 }}>
              613-555-5555
            </Typography>
          </Box>
          <Typography variant="body2" sx={{ fontWeight: 400, fontSize: '0.85rem', color: 'white', mx: 2, py: 0.6 }}>
      ...
      <MainBar>
        <Container maxWidth="xl" sx={{ width: '100%', maxWidth: { xs: '100%', sm: '100%', md: '100%', lg: '1400px', xl: '1500px' } }}>
